# kickoffDevDeapServer Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffDev/kickoffDevDeapServer` module boundary.
