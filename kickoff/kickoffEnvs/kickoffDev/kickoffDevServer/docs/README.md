# kickoffDevServer Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffDev/kickoffDevServer` module boundary.
