# kickoffDevServer LLM Context

This folder contains module-owned LLM context for `kickoffDevServer`.
...
2. Read this module context before changing `kickoffDevServer`.
