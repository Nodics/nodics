# kickoffLocalCronServer Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalCronServer` module boundary.
