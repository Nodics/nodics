# kickoffLocalNemsServer LLM Context

This folder contains module-owned LLM context for `kickoffLocalNemsServer`.
...
2. Read this module context before changing `kickoffLocalNemsServer`.
