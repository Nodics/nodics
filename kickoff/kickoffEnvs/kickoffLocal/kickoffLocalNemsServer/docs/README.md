# kickoffLocalNemsServer Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalNemsServer` module boundary.
