# kickoffLocalDeapNode2 LLM Context

This folder contains module-owned LLM context for `kickoffLocalDeapNode2`.
...
2. Read this module context before changing `kickoffLocalDeapNode2`.
