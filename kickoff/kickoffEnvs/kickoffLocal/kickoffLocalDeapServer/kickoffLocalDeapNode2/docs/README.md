# kickoffLocalDeapNode2 Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalDeapServer/kickoffLocalDeapNode2` module boundary.
