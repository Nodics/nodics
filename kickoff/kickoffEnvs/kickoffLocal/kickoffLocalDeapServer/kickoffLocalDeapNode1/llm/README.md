# kickoffLocalDeapNode1 LLM Context

This folder contains module-owned LLM context for `kickoffLocalDeapNode1`.
...
2. Read this module context before changing `kickoffLocalDeapNode1`.
