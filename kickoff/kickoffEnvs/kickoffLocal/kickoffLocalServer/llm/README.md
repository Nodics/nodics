# kickoffLocalServer LLM Context

This folder contains module-owned LLM context for `kickoffLocalServer`.
...
2. Read this module context before changing `kickoffLocalServer`.
