# kickoffLocalServer AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalServer` module boundary.
