# kickoffLocalNode2 Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalServer/kickoffLocalNode2` module boundary.
