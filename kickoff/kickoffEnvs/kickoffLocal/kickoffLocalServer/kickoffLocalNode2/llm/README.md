# kickoffLocalNode2 LLM Context

This folder contains module-owned LLM context for `kickoffLocalNode2`.
...
2. Read this module context before changing `kickoffLocalNode2`.
