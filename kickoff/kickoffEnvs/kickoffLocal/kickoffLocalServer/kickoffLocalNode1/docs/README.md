# kickoffLocalNode1 Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalServer/kickoffLocalNode1` module boundary.
