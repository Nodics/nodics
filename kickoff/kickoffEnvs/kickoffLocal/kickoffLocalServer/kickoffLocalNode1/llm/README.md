# kickoffLocalNode1 LLM Context

This folder contains module-owned LLM context for `kickoffLocalNode1`.
...
2. Read this module context before changing `kickoffLocalNode1`.
