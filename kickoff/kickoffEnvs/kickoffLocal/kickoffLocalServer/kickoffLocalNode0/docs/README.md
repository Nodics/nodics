# kickoffLocalNode0 Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalServer/kickoffLocalNode0` module boundary.
