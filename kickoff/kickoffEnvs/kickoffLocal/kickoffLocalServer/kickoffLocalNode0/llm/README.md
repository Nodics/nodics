# kickoffLocalNode0 LLM Context

This folder contains module-owned LLM context for `kickoffLocalNode0`.
...
2. Read this module context before changing `kickoffLocalNode0`.
