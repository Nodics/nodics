# kickoffLocalProfileServer LLM Context

This folder contains module-owned LLM context for `kickoffLocalProfileServer`.
...
2. Read this module context before changing `kickoffLocalProfileServer`.
