# kickoffLocalCmsServer AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `kickoff/kickoffEnvs/kickoffLocal/kickoffLocalCmsServer` module boundary.
