# kickoffProdServer Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffProd/kickoffProdServer` module boundary.
