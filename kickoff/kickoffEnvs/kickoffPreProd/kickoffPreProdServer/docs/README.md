# kickoffPreProdServer Documentation

This folder contains permanent human-readable documentation for the `kickoff/kickoffEnvs/kickoffPreProd/kickoffPreProdServer` module boundary.
