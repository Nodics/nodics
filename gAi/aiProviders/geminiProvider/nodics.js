 ...
 * @description Generated Nodics lifecycle entrypoint for geminiProvider.
 * @layer module
 * @owner generated
...
module.exports = {
    ...
    postInit: function (options) {
        SERVICE.DefaultAiProviderGatewayService.register('gemini',
            SERVICE.DefaultGeminiProviderAdapterService);
        return Promise.resolve(true);
    },

    /** Removes the adapter from the parent registry during module shutdown. */
    deInit: function () {
        SERVICE.DefaultAiProviderGatewayService.unregister('gemini');
        return Promise.resolve(true);
    }
};
