 ...
 * @description Generated Nodics lifecycle entrypoint for openAiProvider.
 * @layer module
 * @owner generated
...
module.exports = {
    ...
    postInit: function (options) {
        SERVICE.DefaultAiProviderGatewayService.register('openAi',
            SERVICE.DefaultOpenAiProviderAdapterService);
        return Promise.resolve(true);
    },

    /** Removes the adapter from the parent registry during module shutdown. */
    deInit: function () {
        SERVICE.DefaultAiProviderGatewayService.unregister('openAi');
        return Promise.resolve(true);
    }
};
