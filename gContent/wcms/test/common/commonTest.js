...
*/
/**
 * @module wcms/test/common/commonTest
 * @description Common sample test scaffold for WCMS content module contracts.
 * @layer test
 * @owner wcms
 * @override Project content modules may replace this scaffold with concrete WCMS contract tests.
 */
