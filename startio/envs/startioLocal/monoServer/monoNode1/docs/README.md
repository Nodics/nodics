# monoNode1 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/monoServer/monoNode1` module boundary.
