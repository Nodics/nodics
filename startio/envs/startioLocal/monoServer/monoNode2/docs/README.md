# monoNode2 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/monoServer/monoNode2` module boundary.
