# monoNode2 AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `startio/envs/startioLocal/monoServer/monoNode2` module boundary.
