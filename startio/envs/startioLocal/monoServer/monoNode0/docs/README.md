# monoNode0 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/monoServer/monoNode0` module boundary.
