...
/**
 * @module startio/envs/startioLocal/startioLocalBackofficeServer/test/backofficeServerCompositionContract
 * @description Validates the local BackOffice modular server composition without duplicating capability authority.
 * @layer test
 * @owner startioLocalBackofficeServer
 */
...
assert(properties.activeModules.modules.includes('startioLocalBackofficeServer'), 'BackOffice server must activate its server layer');
