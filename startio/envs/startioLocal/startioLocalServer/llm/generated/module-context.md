# startioLocalServer Module Context
...
| Field | Value |
| --- | --- |
| Module | `startioLocalServer` |
| Path | `startio/envs/startioLocal/startioLocalServer` |
| Kind | `server` |
| Runtime | `none` |
| Index | `3001.11` |
| Version | `0.0.1` |
| Description | Startio module for startioLocalServer |
...
- `startio/envs/startioLocal/startioLocalServer/AGENTS.md`
- `startio/envs/startioLocal/startioLocalServer/nodics.js`
- `startio/envs/startioLocal/startioLocalServer/package.json`
- `startio/envs/startioLocal/startioLocalServer/README.md`
...
| --- | --- | --- | ---: | --- | --- |
| `startio/envs/startioLocal/startioLocalServer/AGENTS.md` | `AGENTS.md` | `inventory-only` | 0/0 | Tracked as module-owned context; source JSDoc is not required for this file type. |  |
| `startio/envs/startioLocal/startioLocalServer/README.md` | `metadata` | `inventory-only` | 0/0 | Tracked as module-owned context; source JSDoc is not required for this file type. |  |
| `startio/envs/startioLocal/startioLocalServer/config/postscripts.js` | `config` | `documented` | 0/0 | Defines default envs configuration used during module startup and layering. |  |
| `startio/envs/startioLocal/startioLocalServer/config/prescripts.js` | `config` | `documented` | 0/0 | Defines default envs configuration used during module startup and layering. |  |
| `startio/envs/startioLocal/startioLocalServer/config/properties.js` | `config` | `documented` | 0/0 | Defines default envs configuration used during module startup and layering. |  |
