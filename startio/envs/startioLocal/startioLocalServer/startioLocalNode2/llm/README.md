# startioLocalNode2 LLM Context

This folder contains module-owned LLM context for `startioLocalNode2`.
...
2. Read this module context before changing `startioLocalNode2`.
