# startioLocalNode2 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/startioLocalServer/startioLocalNode2` module boundary.
