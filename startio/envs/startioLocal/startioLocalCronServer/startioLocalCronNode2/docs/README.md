# startioLocalCronNode2 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/startioLocalCronServer/startioLocalCronNode2` module boundary.
