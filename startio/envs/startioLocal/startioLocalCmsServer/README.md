...
`startioLocalCmsServer` is the local Staged publishing runtime for CMS, Pricing,
and Product authoring and approval in the `startio` reference application. The
historical module name does not make CMS the owner of Pricing or Product.
