# startioLocalDeapNode2 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/startioLocalDeapServer/startioLocalDeapNode2` module boundary.
