# deapNode1 Documentation

This folder contains permanent human-readable documentation for the `startio/envs/startioLocal/deapServer/deapNode1` module boundary.
