...
const stagedPricingSchemas = require('../../startioLocalCmsServer/src/schemas/schemas').pricing;
const onlinePricingSchemas = require('../src/schemas/schemas').pricing;
const stagedProductSchemas = require('../../startioLocalCmsServer/src/schemas/schemas').product;
