...
`startioCore` owns core domain behavior for the `startio` application. It provides project-specific schema, route, service, pipeline, utility, configuration, and test space.
