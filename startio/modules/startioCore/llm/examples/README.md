# startioCore AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `startio/modules/startioCore` module boundary.
