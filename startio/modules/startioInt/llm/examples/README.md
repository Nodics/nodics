# startioInt AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `startio/modules/startioInt` module boundary.
