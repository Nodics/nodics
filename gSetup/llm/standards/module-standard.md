...
6. Verify the module-local `README.md`, `AGENTS.md`, `llm/contracts`,
   `llm/examples`, focused tests, and canonical documentation content explain
   the ownership and extension path.
7. Verify the generated module `AGENTS.md` and `README.md` preserve the
   README/AGENTS/LLM purpose boundary and pre-implementation study gate.
