...
provide default capabilities and behavior; project, environment, server, node,
tenant, and customer modules can override schemas, services, routers, pipelines,
data, tests, configuration, and runtime behavior without changing
