# gframesLocalServer LLM Context

This folder contains module-owned LLM context for `gframesLocalServer`.
...
2. Read this module context before changing `gframesLocalServer`.
