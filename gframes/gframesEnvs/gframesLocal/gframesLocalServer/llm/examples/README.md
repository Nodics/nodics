# gframesLocalServer AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `gframes/gframesEnvs/gframesLocal/gframesLocalServer` module boundary.
