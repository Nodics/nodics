...
| --- | --- |
| Module | `gframesLocal` |
| Path | `gframes/gframesEnvs/gframesLocal` |
| Kind | `environment` |
| Runtime | `none` |
| Index | `2000.10.1.1` |
| Version | `0.0.1` |
| Description | Nodics applicaion module. This module hold all configuration and business logic related to gframesLocal |
...
- `gframes/gframesEnvs/gframesLocal/AGENTS.md`
- `gframes/gframesEnvs/gframesLocal/nodics.js`
- `gframes/gframesEnvs/gframesLocal/package.json`
- `gframes/gframesEnvs/gframesLocal/README.md`
- `gframes/gframesEnvs/gframesLocal/config/properties.js`
- `gframes/gframesEnvs/gframesLocal/config/prescripts.js`
- `gframes/gframesEnvs/gframesLocal/config/postscripts.js`
