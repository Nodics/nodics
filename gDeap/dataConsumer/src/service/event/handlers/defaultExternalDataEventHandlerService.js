...
/**
 * @module gDeap/dataConsumer/src/service/event/handlers/defaultExternalDataEventHandlerService
 * @description Implements dataConsumer default external data event handler service business behavior and extension logic.
 * @layer service
 * @owner dataConsumer
...
module.exports = {
     ...
     * Processes external data push event behavior.
