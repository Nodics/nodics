...
/**
 * @module nAuth/test/integration/AuthIdentityIsolationContract
...
const secret = 'auth-distributed-test-jwt-secret-with-more-than-thirty-two-characters';
const pepper = 'auth-distributed-test-api-key-pepper-with-more-than-thirty-two-characters';
const values = {
    profileModuleName: 'profile',
    nodeId: 'auth-distributed-node-a',
    authSecurity: {
...
async function run() {
    ...
    console.log('nAuth distributed authentication identity isolation contract validated');
}
