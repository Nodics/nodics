...
| `gFramework/nCommon/src/utils/utils.js` | `src` | `documented` | 15/15 | Shared utility contributions for identifiers, password hashing, recursive file discovery, trusted script evaluation, error normalization, and inherited user-group access resolution. |  |
