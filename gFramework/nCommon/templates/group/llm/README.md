# customApplication LLM Context

This folder contains module-owned LLM context for `customApplication`.
...
2. Read this module context before changing `customApplication`.
