...
/**
 * @module gFramework/nbpm/src/service/event/schema2Workflow/defaultWorkflow2SchemaChangeListenerService
 * @description Implements nbpm default workflow2 schema change listener service business behavior and extension logic.
 * @layer service
 * @owner nbpm
...
module.exports = {
     ...
     * Processes workflow2 schema update event handler behavior.
