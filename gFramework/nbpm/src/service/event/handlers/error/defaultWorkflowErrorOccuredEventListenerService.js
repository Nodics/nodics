...
module.exports = {
     ...
     * Processes workflow error occured event behavior.
    ...
    handleWorkflowErrorOccuredEvent: function (request, callback) {
        try {
            ...
            SERVICE.DefaultPipelineService.start('defaultWorkflowErrorOccurredPipeline', {
                ...
                callback(new CLASSES.EventError(error, 'Unable to handle error occured event', 'ERR_EVNT_00000'));
            });
        } catch (error) {
