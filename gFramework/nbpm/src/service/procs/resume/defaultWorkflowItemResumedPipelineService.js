...
module.exports = {
    ...
    validateRequest: function (request, response, process) {
        this.LOG.debug('Validating input for workflow item resumed process');
        if (!request.tenant) {
    ...
    prepareModel: function (request, response, process) {
        this.LOG.debug('Preparing model to update resumed item');
    ...
    updateSchemaItem: function (request, response, process) {
        this.LOG.debug('Updating schema item for resumed item');
        try {
