...
/**
 * @module gFramework/nbpm/src/service/procs/updated/defaultWorkflowCarrierFilledPipelineService
 * @description Implements nbpm default workflow carrier filled pipeline service business behavior and extension logic.
 * @layer service
 * @owner nbpm
...
module.exports = {
    ...
    validateRequest: function (request, response, process) {
        this.LOG.debug('Validating input for workflow carrier filled process');
    ...
    updateSchemaItems: function (request, response, process) {
        this.LOG.debug('Updating schema items for carrier filled item');
        try {
    ...
    updateSearchItems: function (request, response, process) {
        this.LOG.debug('Updating search item for carrier filled item');
