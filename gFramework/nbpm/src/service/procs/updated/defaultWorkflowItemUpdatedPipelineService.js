...
module.exports = {
    ...
    validateRequest: function (request, response, process) {
        this.LOG.debug('Validating input for workflow item update process');
        if (!request.tenant) {
    ...
    prepareModel: function (request, response, process) {
        this.LOG.debug('Preparing model to update update item');
    ...
    updateSchemaItem: function (request, response, process) {
        this.LOG.debug('Updating schema item for update item');
        try {
    ...
    updateSearchItem: function (request, response, process) {
        this.LOG.debug('Updating search item for update item');
        try {
