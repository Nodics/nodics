 ...
 * @description Generates safe provider-relative media storage keys.
 * @layer service
 * @owner nMedia
 * @override Later layers may replace key strategy while preserving traversal protection and backend authority.
 */
module.exports = {
    ...
    buildStorageKey: function (request) {
        ...
        return this.assertSafeStorageKey([
            tenant,
            enterprise,
            this.cleanSegment(folder.storagePrefix || folder.code || 'general'),
            yyyy,
            mm,
            storedFileName
        ].join('/'));
