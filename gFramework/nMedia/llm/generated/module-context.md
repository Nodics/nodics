...
| `gFramework/nMedia/src/controller/storage/defaultMediaStorageController.js` | `src` | `documented` | 22/22 | Exposes nMedia storage policy and location controller operations. |  |
...
| `gFramework/nMedia/src/facade/storage/defaultMediaStorageFacade.js` | `src` | `documented` | 19/19 | Delegates media storage policy and location operations. |  |
...
| `gFramework/nMedia/src/service/storage/defaultMediaStoragePolicyService.js` | `src` | `documented` | 34/34 | Resolves and validates backend-owned media storage policy. |  |
| `gFramework/nMedia/src/service/storage/defaultMediaStorageProviderRegistryService.js` | `src` | `documented` | 11/11 | Selects and invokes the configured nMedia storage provider. |  |
...
| `gFramework/nMedia/src/service/storage/provider/defaultLocalMediaStorageProviderService.js` | `src` | `documented` | 10/10 | Local filesystem media provider for development and simple deployments. |  |
...
| `gFramework/nMedia/test/mediaStorageProviderSummaryContract.test.js` | `test` | `documented` | 0/0 | Validates safe provider summary metadata for Media Management operations. |  |
