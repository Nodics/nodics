...
| `gFramework/nCache/cache/src/service/policy/defaultCachePolicyService.js` | `src` | `documented` | 17/17 | Centralizes router/API and DAO/schema cacheability decisions using layered properties while preserving legacy utility checks. |  |
