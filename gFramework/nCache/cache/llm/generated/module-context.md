...
| `gFramework/nCache/cache/src/service/policy/defaultCachePolicyService.js` | `src` | `documented` | 16/16 | Centralizes router/API and DAO/schema cacheability decisions using layered properties while preserving legacy utility checks. |  |
