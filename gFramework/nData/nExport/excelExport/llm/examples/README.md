# excelExport AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `gFramework/nData/nExport/excelExport` module boundary.
