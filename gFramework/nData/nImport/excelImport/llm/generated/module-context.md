...
| `gFramework/nData/nImport/excelImport/config/postscripts.js` | `config` | `documented` | 0/0 | Defines default nData configuration used during module startup and layering. |  |
| `gFramework/nData/nImport/excelImport/config/prescripts.js` | `config` | `documented` | 0/0 | Defines default nData configuration used during module startup and layering. |  |
| `gFramework/nData/nImport/excelImport/config/properties.js` | `config` | `documented` | 0/0 | Defines default nData configuration used during module startup and layering. |  |
...
| `gFramework/nData/nImport/excelImport/nodics.js` | `module` | `documented` | 2/2 | Registers the nData module lifecycle hooks and module-level startup behavior. |  |
...
| `gFramework/nData/nImport/excelImport/src/pipelines/pipelinesDefinition.js` | `src` | `documented` | 0/0 | Defines nData pipeline wiring and execution contracts. |  |
| `gFramework/nData/nImport/excelImport/src/router/appConfig.js` | `src` | `documented` | 0/0 | Defines nData route registration and HTTP exposure metadata. |  |
| `gFramework/nData/nImport/excelImport/src/router/router.js` | `src` | `documented` | 0/0 | Defines nData route registration and HTTP exposure metadata. |  |
...
| `gFramework/nData/nImport/excelImport/test/common/commonTest.js` | `test` | `partially-documented` | 0/7 | Defines nData test fixtures or suites for module behavior validation. | add JSDoc for 7 exported method(s) |
| `gFramework/nData/nImport/excelImport/test/env-local/envTest.js` | `test` | `partially-documented` | 0/7 | Defines nData test fixtures or suites for module behavior validation. | add JSDoc for 7 exported method(s) |
