...
- `gFramework/nDatabase/elasticdb/src/router/routers.js`
...
| `gFramework/nDatabase/elasticdb/src/pipelines/pipelines.js` | `src` | `documented` | 0/0 | Elastic database adapter pipeline extension slot. |  |
...
| `gFramework/nDatabase/elasticdb/src/router/routers.js` | `src` | `documented` | 0/0 | Elastic database adapter route definition extension slot. |  |
...
| `gFramework/nDatabase/elasticdb/src/utils/enums.js` | `src` | `documented` | 0/0 | Provides shared elasticdb enum definition exports. |  |
| `gFramework/nDatabase/elasticdb/src/utils/statusDefinitions.js` | `src` | `documented` | 0/0 | Provides shared elasticdb status and error definition exports. |  |
