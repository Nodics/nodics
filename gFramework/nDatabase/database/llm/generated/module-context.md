...
| `gFramework/nDatabase/database/src/service/schema/defaultSchemaWorkbenchService.js` | `src` | `documented` | 29/29 | Projects effective Nodics schemas into a client-safe, searchable model contract for schema-driven BackOffice experiences. It never creates another schema registry and never executes data mutations. |  |
