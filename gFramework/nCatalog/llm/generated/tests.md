...
- `gFramework/nCatalog/test/gen/api/catalogApiContract.test.js`
- `gFramework/nCatalog/test/gen/apiScenario/catalogApiScenario.test.js`
- `gFramework/nCatalog/test/gen/crud/catalogCrudScenario.test.js`
- `gFramework/nCatalog/test/gen/schema/catalogSchemaContract.test.js`
