...
const { collectGeneratedTests } = require('./runGeneratedTests');
const { collectTenantGuardFailures } = require('./liveTestTenantGuard');

/**
 * @module nTest/tooling/runGeneratedAccessPolicyLiveTests
