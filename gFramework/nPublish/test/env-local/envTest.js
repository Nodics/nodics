...
*/
/**
 * @module nPublish/test/env-local/envTest
 * @description Local-environment sample test scaffold for publish module behavior.
 * @layer test
 * @owner nPublish
 * @override Project modules may add environment-specific publishing tests.
 */
