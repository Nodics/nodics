...
| `gFramework/nRouter/src/service/defaultHttpHardeningService.js` | `src` | `documented` | 15/15 | Applies topology-aware HTTP hardening to Express applications using layered Nodics configuration for proxy trust, security headers, CORS, rate limits, and body parser limits. |  |
