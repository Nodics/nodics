...
/**
 * @module gFramework/nDynamo/src/service/event/defaultSchemaConfigurationChangeListenerService
 * @description Implements nDynamo default schema configuration change listener service business behavior and extension logic.
 * @layer service
 * @owner nDynamo
...
module.exports = {
     ...
     * Processes schema update event handler behavior.
