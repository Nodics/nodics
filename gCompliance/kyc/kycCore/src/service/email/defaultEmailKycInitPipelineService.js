...
/**
 * @module gCompliance/kyc/kycCore/src/service/email/defaultEmailKycInitPipelineService
 * @description Implements kyc default email kyc init pipeline service business behavior and extension logic.
 * @layer service
 * @owner kyc
