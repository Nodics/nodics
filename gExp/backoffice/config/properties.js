    ...
    backofficeCapabilities: {
        backoffice: {
            ...
            navigation: [
                ...
                { id: 'core-data', label: 'Core Data', route: '/administration/core-data', icon: 'import',
                ...
                ...['Integrations', 'Imports and Exports', 'Events', 'Audit Trail',
                    'Operational Failures'].map((label, index) => ({
                    id: ['integrations', 'imports-exports', 'events', 'audit-trail',
                        'operational-failures'][index],
                    label,
                    route: '/operations/' + ['integrations', 'imports-exports', 'events',
