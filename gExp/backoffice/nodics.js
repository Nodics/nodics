...
/**
 * @module backoffice
 * @description Declares the lifecycle boundary for the BackOffice registry and discovery capability.
 * @layer module
 * @owner backoffice
 * @override Later active modules may extend lifecycle behavior without modifying this capability.
 */
module.exports = {
    /**
