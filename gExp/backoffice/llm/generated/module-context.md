...
| `gExp/backoffice/src/service/registry/defaultBackofficeRegistryService.js` | `src` | `documented` | 30/30 | Owns ephemeral observed module-instance leases for BackOffice discovery without becoming topology or activation authority. |  |
