...
```bash
node gComm/baseCommerce/product/test/productFoundationContract.test.js
node gComm/baseCommerce/product/test/productCategoryContract.test.js
node gComm/baseCommerce/product/test/productClassificationContract.test.js
node gComm/baseCommerce/product/test/productVariantContract.test.js
node gComm/baseCommerce/product/test/productCompositionContract.test.js
node gComm/baseCommerce/product/test/productPublicationContract.test.js
node gComm/baseCommerce/product/test/productOnlineDeliveryAndProjectionContract.test.js
node gComm/baseCommerce/product/test/productStorefrontDeliveryContract.test.js
node gComm/baseCommerce/product/test/productManagementAndReferenceContract.test.js
node gComm/baseCommerce/product/test/productProviderAndOverrideContract.test.js
```
