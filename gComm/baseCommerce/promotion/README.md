...
```bash
node gComm/baseCommerce/promotion/test/promotionFoundationContract.test.js
node gComm/baseCommerce/promotion/test/promotionEvaluationContract.test.js
node gComm/baseCommerce/promotion/test/promotionRuntimePipelineDelegateContract.test.js
node gComm/baseCommerce/promotion/test/promotionLifecycleWorkflowContract.test.js
