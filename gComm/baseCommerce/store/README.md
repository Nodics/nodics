...
```bash
node gComm/baseCommerce/store/test/storeFoundationSchemaContract.test.js
node gComm/baseCommerce/store/test/storeFoundationService.test.js
node gComm/baseCommerce/store/test/storeManagementContract.test.js
```
