...
module.exports = {
  ...
  storeWarehouseAssignmentPreSave: {
    type: "schema",
    item: "storeWarehouseAssignment",
    trigger: "preSave",
    active: "true",
    index: -100,
    handler:
      "DefaultStoreWarehouseAssignmentFoundationService.prepareAssignmentSave",
  },
  ...
  storeWarehouseAssignmentPreUpdate: {
    ...
    index: -100,
    handler:
      "DefaultStoreWarehouseAssignmentFoundationService.prepareAssignmentUpdate",
  },
  storeWarehouseAssignmentPreRemove: {
    ...
    index: -100,
    handler:
      "DefaultStoreWarehouseAssignmentFoundationService.rejectHardDelete",
  },
  pointOfServicePreSave: {
    ...
    active: "true",
    index: -100,
    handler: "DefaultPointOfServiceFoundationService.preparePointOfServiceSave",
  },
  ...
  pointOfServicePreUpdate: {
    ...
    index: -100,
    handler:
      "DefaultPointOfServiceFoundationService.preparePointOfServiceUpdate",
  },
  pointOfServicePreRemove: {
    ...
    active: "true",
    index: -100,
    handler: "DefaultPointOfServiceFoundationService.rejectHardDelete",
  },
};
