...
module.exports = {
    ...
    /** Cancels an exact approved allocation quantity through durable Inventory checkpoints. */ cancelQuantity: async function (request) { this.authorize(request); return { code: 'SUC_INV_00009', data: await SERVICE.DefaultStockAllocationCancellationOrchestrationService.cancel(request) }; },
