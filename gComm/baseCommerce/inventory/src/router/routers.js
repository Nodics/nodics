...
module.exports = {
    inventory: {
        ...
        stockAllocationIntent: {
            ...
            cancelAllocationQuantity: { secured: true, accessGroups: ['userGroup'], permissionConfig: 'authSecurity.internalToken.routePermission', apiExposure: 'moduleInternal', key: '/references/stock-allocations/cancel-quantity', method: 'POST', controller: 'DefaultStockAllocationIntentController', operation: 'cancelQuantity', requestBody: { required: true, content: { 'application/json': { schema: { type: 'object' } } } }, responses: { '200': { description: 'Idempotently cancelled exact unfulfilled allocation quantity' } } },
