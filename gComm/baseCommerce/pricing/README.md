...
```bash
node gComm/baseCommerce/pricing/test/pricingFoundationContract.test.js
node gComm/baseCommerce/pricing/test/priceResolutionContract.test.js
node gComm/baseCommerce/pricing/test/pricingPublicationContract.test.js
node gComm/baseCommerce/pricing/test/pricingManagementContract.test.js
node gComm/baseCommerce/pricing/test/pricingPublicationWorkflowContract.test.js
