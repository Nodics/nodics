          ...
          detailPanels: [
            {
              ...
              relation: { sourceField: "promiseCode", targetField: "promiseCode" },
            },
          ],
          help: {
            summary:
  ...
  inventory: {
    ...
    stockAllocation: {
      ...
      returnDisposition: {
        ...
        recovery: {
          enabled: true,
          reviewActions: ["REVIEW_DISPOSITION_MOVEMENT", "ADJUST_THROUGH_STOCK_MOVEMENT"],
        },
    ...
    inventoryPromise: {
      ...
      paymentRequirements: ["NONE", "ADVANCE", "DEPOSIT", "FULL_PAYMENT", "BALANCE"],
      defaultScale: 6,
      maximumScale: 18,
      roundingMode: "UNNECESSARY",
