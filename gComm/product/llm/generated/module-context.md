...
| `gComm/product/test/productFoundationContract.test.js` | `test` | `documented` | 0/0 | Proves Product foundation schemas, enterprise isolation, derived identity, type policy, Catalog and Units references, lifecycle, and retained history. |  |
