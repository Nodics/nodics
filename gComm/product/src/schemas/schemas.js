...
module.exports = { product: {
    ...
    productMediaReference: governed(Object.assign(common(), {
        mediaReferenceCode: { type: 'string', required: true, description: 'Stable Product-owned media assignment identity' },
    ...
    }), { common: { enterpriseCode: { enabled: true, name: 'enterpriseCode' }, catalogCode: { enabled: true, name: 'catalogCode' }, mediaReferenceCode: { enabled: true, name: 'mediaReferenceCode' } }, individual: { mediaReferenceCode: { enabled: true, name: 'mediaReferenceCode' }, mediaCode: { enabled: true, name: 'mediaCode' }, mediaSetCode: { enabled: true, name: 'mediaSetCode' }, itemCode: { enabled: true, name: 'itemCode' }, mediaType: { enabled: true, name: 'mediaType' }, role: { enabled: true, name: 'role' }, position: { enabled: true, name: 'position' }, status: { enabled: true, name: 'status' } } }),
