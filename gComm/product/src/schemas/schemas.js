...
module.exports = { product: {
    ...
    productMedia: governed(Object.assign(common(), {
        productMediaCode: { type: 'string', required: true, description: 'Stable Product-owned media assignment identity' },
        mediaCode: { type: 'string', required: false, description: 'Optional nMedia-owned single Media item reference' },
        mediaSetCode: { type: 'string', required: false, description: 'Optional nMedia-owned reusable Media Set reference' },
        itemType: { type: 'string', required: true }, itemCode: { type: 'string', required: true },
        mediaType: { type: 'string', required: true }, role: { type: 'string', required: true }, localeCode: { type: 'string', required: false },
        position: { type: 'int', required: true, default: 100 }, altText: { type: 'string', required: false }
    }), { common: { enterpriseCode: { enabled: true, name: 'enterpriseCode' }, catalogCode: { enabled: true, name: 'catalogCode' }, productMediaCode: { enabled: true, name: 'productMediaCode' } }, individual: { productMediaCode: { enabled: true, name: 'productMediaCode' }, mediaCode: { enabled: true, name: 'mediaCode' }, mediaSetCode: { enabled: true, name: 'mediaSetCode' }, itemCode: { enabled: true, name: 'itemCode' }, mediaType: { enabled: true, name: 'mediaType' }, role: { enabled: true, name: 'role' }, position: { enabled: true, name: 'position' }, status: { enabled: true, name: 'status' } } }),
