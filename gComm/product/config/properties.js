...
module.exports = {
    ...
    product: {
        ...
        management: { maximumResultCount: 500, maximumPayloadBytes: 262144, allowedResources: ['items', 'identifiers', 'categories', 'categoryAssignments', 'attributeDefinitions', 'attributeValues', 'classificationClasses', 'classificationAssignments', 'variantAxes', 'variantAssignments', 'relations', 'bundleEntries', 'packaging', 'media'] },
        workflow: { enabled: true, defaultMode: 'MANUAL', modes: ['MANUAL', 'AUTOMATIC'], manualWorkflowCode: 'productPublicationManualFlow', automaticWorkflowCode: 'productPublicationAutomaticFlow', maximumAssociatedItems: 20000, allowedAssociatedSchemas: ['productItem', 'productIdentifier', 'productCategory', 'productCategoryAssignment', 'productAttributeDefinition', 'productAttributeValue', 'productClassificationClass', 'productClassificationAssignment', 'productVariantAxis', 'productVariantAssignment', 'productRelation', 'productBundleEntry', 'productPackaging', 'productMedia'] },
