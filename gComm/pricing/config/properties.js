...
module.exports = {
  backofficeCapabilities: {
    pricing: {
      ...
      navigation: [
        ...
        {
          id: "delivery-charge-quotes",
          parentId: "pricing",
          label: "Delivery Charges",
          route: "/commerce/operations/pricing/delivery-charges",
          icon: "pricing",
          order: 526,
          group: { id: "commerce", label: "Commerce", order: 300 },
          perspectives: ["operations", "commerce"],
          ...
          workbenchTarget: {
            moduleName: "pricing",
            schemaName: "deliveryChargeQuote",
          },
          ...
          help: {
            summary:
              "Review customer-facing delivery charge quotes owned by Pricing and accepted into cart or order delivery groups as immutable checkout evidence.",
            documentationRoute:
              "/docs/capabilities/commerce/pricing/delivery-charges",
          },
        },
      ],
    },
  ...
  pricing: {
    ...
    deliveryCharge: {
      taxModes: ["NET", "GROSS"],
      calculationStrategies: ["STATIC_POLICY", "RATE_CARD", "CARRIER_QUOTE"],
      sourceTypes: ["ESTIMATE", "RATE_CARD", "CARRIER_QUOTE", "MANUAL"],
    },
    resolution: {
