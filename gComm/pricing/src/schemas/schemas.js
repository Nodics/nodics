...
const common = function () {
  return {
    enterpriseCode: {
      type: "string",
      required: true,
      description: "Authenticated enterprise owner",
    },
    status: {
      type: "string",
      required: true,
      default: "DRAFT",
      description: "Governed lifecycle state",
    },
...
module.exports = {
  pricing: {
    priceList: governed(
      Object.assign(common(), {
        priceListCode: {
          type: "string",
          required: true,
          description: "Stable business price-list code",
        },
    ...
    priceListAssignment: governed(
      Object.assign(common(), {
        assignmentCode: { type: "string", required: true },
        priceListCode: { type: "string", required: true },
        scopeType: { type: "string", required: true },
        scopeCode: { type: "string", required: true },
        priority: { type: "int", required: true, default: 100 },
        excluded: { type: "bool", required: true, default: false },
      }),
      {
        common: {
          enterpriseCode: { enabled: true, name: "enterpriseCode" },
          assignmentCode: { enabled: true, name: "assignmentCode" },
        },
        individual: {
          assignmentCode: {
            enabled: true,
          ...
          priceListCode: { enabled: true, name: "priceListCode" },
          scopeType: { enabled: true, name: "scopeType" },
          scopeCode: { enabled: true, name: "scopeCode" },
        },
      },
    ),
    priceGroup: governed(
      Object.assign(common(), {
        priceGroupCode: { type: "string", required: true },
        name: { type: "string", required: true },
      ...
      }),
      {
        common: {
          enterpriseCode: { enabled: true, name: "enterpriseCode" },
          priceGroupCode: { enabled: true, name: "priceGroupCode" },
        },
        individual: {
          priceGroupCode: {
            enabled: true,
          ...
          groupType: { enabled: true, name: "groupType" },
        },
      },
    ),
    priceGroupMember: governed(
      Object.assign(common(), {
      ...
      }),
      {
        common: {
          enterpriseCode: { enabled: true, name: "enterpriseCode" },
          membershipCode: { enabled: true, name: "membershipCode" },
        },
        individual: {
          membershipCode: {
            enabled: true,
          ...
          priceGroupCode: { enabled: true, name: "priceGroupCode" },
          memberCode: { enabled: true, name: "memberCode" },
        },
      },
    ),
    price: governed(
      Object.assign(common(), {
        ...
        itemPriceGroupCode: { type: "string", required: false },
        customerCode: { type: "string", required: false },
        customerPriceGroupCode: { type: "string", required: false },
        amount: {
          type: "string",
          required: true,
      ...
      }),
      {
        common: {
          enterpriseCode: { enabled: true, name: "enterpriseCode" },
          priceCode: { enabled: true, name: "priceCode" },
        },
        individual: {
          priceCode: {
            enabled: true,
    ...
    deliveryChargeQuote: governed(
      Object.assign(common(), {
        quoteCode: {
          type: "string",
          required: true,
          description: "Stable business identity for a delivery charge quote",
        },
        cartCode: {
          type: "string",
          required: false,
          description:
            "Optional cart that requested this delivery charge quote",
        },
        deliveryGroupCode: {
          type: "string",
          required: false,
          description:
            "Optional checkout delivery group that accepted this quote",
        },
        deliveryModeCode: {
          type: "string",
          required: true,
          description: "Delivery mode used for this customer-facing quote",
        },
        carrierCode: {
          type: "string",
          required: false,
          description: "Optional carrier candidate used for this quote",
        },
        addressCode: {
          type: "string",
          required: false,
          description:
            "Optional destination address reference used for quote scoping",
        },
        amount: {
          type: "string",
          required: true,
          description:
            "Exact non-negative decimal-string customer-facing delivery charge",
        },
        currencyCode: {
          type: "string",
          required: true,
          description: "Currency for this delivery charge quote",
        },
        taxMode: {
          type: "string",
          required: true,
          default: "NET",
          description: "Tax mode used for the customer-facing delivery charge",
        },
        calculationStrategy: {
          type: "string",
          required: true,
          ...
          description:
            "Configurable strategy or adapter used to calculate the quote",
        },
        sourceType: {
          type: "string",
          required: true,
          default: "ESTIMATE",
          description:
            "Source category such as estimate, rate card, or carrier quote",
        },
        sourceReferenceCode: {
          type: "string",
          required: false,
          description: "Optional external or provider quote reference",
        },
        idempotencyKey: {
          type: "string",
          required: true,
          description:
            "Stable idempotency key for repeated delivery quote requests",
        },
        validUntil: {
          type: "date",
          required: false,
          description: "Optional expiry time for quote acceptance",
        },
      }),
      {
        common: {
        ...
        individual: {
          ...
          deliveryModeCode: { enabled: true, name: "deliveryModeCode" },
          currencyCode: { enabled: true, name: "currencyCode" },
          status: { enabled: true, name: "status" },
    ...
    pricePublicationManifest: {
      ...
      definition: {
        ...
        sourceVersion: { type: "int", required: true },
