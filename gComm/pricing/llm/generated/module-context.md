...
| `gComm/pricing/src/service/foundation/defaultPricingValidationService.js` | `src` | `partially-documented` | 27/27 | Purpose is not documented; inspect the implementation and add a platform-level `@description`. | add @override |
