...
module.exports = {
    fulfillment: {
        ...
        fulfillmentConsignment: governed(Object.assign(common('RELEASED'), {
            ...
            allocationEvidence: { type: 'array', required: false, default: [], description: 'Exact immutable Order delivery-allocation quantity and serial evidence retained for Fulfillment lifecycle decisions' },
            cancelledAllocationEvidence: { type: 'array', required: false, default: [], description: 'Fulfillment-owned cumulative cancelled quantities and serials by delivery allocation' },
            ...
            revision: { type: 'int', required: true, default: 0, description: 'Optimistic Fulfillment consignment lifecycle revision' },
            lastCancellationCode: { type: 'string', required: false, description: 'Last applied Fulfillment cancellation checkpoint identity' },
        ...
        fulfillmentConsignmentCancellation: governed(Object.assign(common('PENDING'), {
            cancellationCode: { type: 'string', required: true, description: 'Stable approved cancellation/version execution identity', searchOptions: { enabled: true } },
            orderCode: { type: 'string', required: true, description: 'Order whose unshipped fulfillment quantity is cancelled', searchOptions: { enabled: true } },
            requestVersion: { type: 'int', required: true, description: 'Immutable approved Order lifecycle request version' },
            revision: { type: 'int', required: true, default: 0, description: 'Optimistic cancellation checkpoint revision' },
            itemSelections: { type: 'array', required: true, description: 'Exact entry quantity and serial selections supplied by approved Workflow evidence' },
            cancellationPlan: { type: 'array', required: true, description: 'Fulfillment-owned deterministic consignment/allocation cancellation plan' },
            appliedConsignments: { type: 'array', required: false, default: [], description: 'Safe applied consignment revision evidence' },
            ...
            individual: {
                cancellationCode: { enabled: true, name: 'cancellationCode', options: { unique: true } },
            },
        }),
        ...
        fulfillmentReturnRequest: governed(Object.assign(common('REQUESTED'), {
            ...
            dispositionCode: { type: 'string', required: false, description: 'Operational disposition such as RESTOCK, REPAIR, SCRAP, INSPECT, QUARANTINE, MISSING, or RETURN_TO_VENDOR', searchOptions: { enabled: true } },
            ...
            inventoryDispositionEvidence: { type: 'object', required: false, description: 'Normalized Inventory-owned stock movement result captured after disposition execution.' },
