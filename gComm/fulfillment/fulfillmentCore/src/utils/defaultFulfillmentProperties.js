  ...
  fulfillment: {
    fulfillmentPolicy: {
      ...
      cancellation: {
        ...
        requireNoShipment: true,
        maximumConsignments: 100,
        maximumAllocations: 1000,
        statuses: ["PENDING", "APPLYING", "COMPLETED", "RECONCILIATION_REQUIRED"],
        cancellableConsignmentStatuses: ["RELEASED", "PICKING", "PACKED", "PARTIALLY_CANCELLED"],
      },
      shipmentStatuses: [
        "CREATED",
        "LABELLED",
      ...
      returnReceiptDisposition: {
        enabled: true,
        pipelineName: "returnReceiptDispositionPipeline",
        inventoryDispositionService: "DefaultReturnDispositionMovementService",
      },
      shippingRefund: { defaultMode: "NONE", allowedModes: ["NONE", "PROPORTIONAL", "FULL", "FIXED"], currencyScale: 2, roundingMode: "HALF_EVEN" },
