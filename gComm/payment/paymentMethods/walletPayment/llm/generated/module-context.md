...
| Path | `gComm/payment/paymentMethods/walletPayment` |
| Kind | `capability` |
| Runtime | `none` |
| Index | `40.723` |
| Version | `0.0.1` |
| Description | Wallet payment-method family configuration boundary. |
...
- `gComm/payment/paymentMethods/walletPayment/AGENTS.md`
- `gComm/payment/paymentMethods/walletPayment/nodics.js`
- `gComm/payment/paymentMethods/walletPayment/package.json`
- `gComm/payment/paymentMethods/walletPayment/README.md`
- `gComm/payment/paymentMethods/walletPayment/config/properties.js`
- `gComm/payment/paymentMethods/walletPayment/config/prescripts.js`
- `gComm/payment/paymentMethods/walletPayment/config/postscripts.js`
...
| --- | --- | --- | ---: | --- | --- |
| `gComm/payment/paymentMethods/walletPayment/AGENTS.md` | `AGENTS.md` | `inventory-only` | 0/0 | Tracked as module-owned context; source JSDoc is not required for this file type. |  |
| `gComm/payment/paymentMethods/walletPayment/README.md` | `metadata` | `inventory-only` | 0/0 | Tracked as module-owned context; source JSDoc is not required for this file type. |  |
| `gComm/payment/paymentMethods/walletPayment/config/postscripts.js` | `config` | `partially-documented` | 0/0 | Purpose is not documented; inspect the implementation and add a platform-level `@description`. | add @override |
