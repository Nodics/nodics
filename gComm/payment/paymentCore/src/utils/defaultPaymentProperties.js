...
/** @module paymentCore/config/properties @description Layered payment policy and BackOffice metadata for the stable payment namespace. @layer configuration @owner paymentCore */
module.exports = {
  payment: {
    paymentPolicy: {
      operations: [
