...
module.exports = {
    ...
    executeFacade: function (operation, request, callback) {
        ...
        let input = Object.assign({}, body, {
            ...
            enterpriseCode: body.enterpriseCode || body.entCode || request && request.entCode
        });
        let promise = Promise.resolve().then(() => FACADE.DefaultPaymentProviderLifecycleFacade[operation](input));
