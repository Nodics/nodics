...
module.exports = {
  ...
  error: function (message) {
    if (typeof CLASSES !== "undefined" && CLASSES.NodicsError)
      return new CLASSES.NodicsError(message, null, "ERR_PAY_00006");
  ...
  method: function (paymentModeCode) {
    ...
    let operation = (policy.deferredPaymentModes || []).includes(code)
      ? "DEFER"
      : "AUTHORIZE";
    return {
      methodCode: code,
      ...
      defaultProviderCode:
        (policy.defaultProviderByPaymentMode || {})[code] ||
        (policy.defaultProviderByPaymentMode || {}).DEFAULT ||
