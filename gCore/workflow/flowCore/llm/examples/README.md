# flowCore AI Examples

This folder contains examples that help AI agents and developers work correctly inside the `gCore/workflow/flowCore` module boundary.
