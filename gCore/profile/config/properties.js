...
module.exports = {
    ...
    backofficeCapabilities: {
        profile: {
            ...
            { id: 'customer-segments', label: 'Customer Segments', route: '/profile/customer-segments', icon: 'profile',
                order: 110, group: { id: 'organization', label: 'Customers and Organization', order: 400 },
                perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                featureState: 'DISABLED' },
            { id: 'employees', label: 'Employees', route: '/profile/employees', icon: 'profile',
                order: 120, group: { id: 'organization', label: 'Customers and Organization', order: 400 },
                perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                featureState: 'DISABLED' },
            { id: 'roles', label: 'Roles', route: '/profile/roles', icon: 'profile',
                order: 130, group: { id: 'organization', label: 'Customers and Organization', order: 400 },
                perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                featureState: 'DISABLED' },
            { id: 'permission-groups', label: 'Permission Groups', route: '/profile/permission-groups', icon: 'profile',
                order: 140, group: { id: 'organization', label: 'Customers and Organization', order: 400 },
                perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                featureState: 'DISABLED' },
            { id: 'enterprises', label: 'Enterprises', route: '/profile/enterprises', icon: 'profile',
                order: 150, group: { id: 'organization', label: 'Customers and Organization', order: 400 },
                perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                featureState: 'DISABLED' },
            { id: 'business-units', label: 'Business Units', route: '/profile/business-units', icon: 'profile',
                order: 160, group: { id: 'organization', label: 'Customers and Organization', order: 400 },
                perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                featureState: 'DISABLED' }]
        }
    },
