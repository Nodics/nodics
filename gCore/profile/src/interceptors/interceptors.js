...
module.exports = {
    ...
    validateEmployeeSave: { type: 'schema', item: 'employee', trigger: 'preSave', active: 'true', index: -20, handler: 'DefaultPrincipalGovernanceService.validateSave' },
    validateEmployeeUpdate: { type: 'schema', item: 'employee', trigger: 'preUpdate', active: 'true', index: -20, handler: 'DefaultPrincipalGovernanceService.validateUpdate' },
    validateCustomerSave: { type: 'schema', item: 'customer', trigger: 'preSave', active: 'true', index: -20, handler: 'DefaultPrincipalGovernanceService.validateSave' },
    validateCustomerUpdate: { type: 'schema', item: 'customer', trigger: 'preUpdate', active: 'true', index: -20, handler: 'DefaultPrincipalGovernanceService.validateUpdate' },
