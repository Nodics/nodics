...
const expectedRoutes = [
    ...
    { key: '/employee/browser/authenticate', method: 'POST', handler: 'DefaultAuthenticationProviderController', operation: 'authenticateEmployeeBrowser', secured: false },
    { key: '/employee/browser/restore', method: 'POST', handler: 'DefaultAuthenticationProviderController', operation: 'restoreEmployeeBrowser', secured: false },
    { key: '/employee/browser/logout', method: 'POST', handler: 'DefaultAuthenticationProviderController', operation: 'logoutEmployeeBrowser', secured: false },
